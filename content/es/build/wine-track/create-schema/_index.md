...
El esquema debe definirse en formato [Json Schema](../../../docs/getting-started/concepts/schema/_index.md) para que kore pueda interpretarlo correctamente. Aquí está el esquema en este formato:
...
Después de declarar nuestro esquema, el siguiente paso es crear el [*contrato*](../../../docs/learn/contracts/_index.md) ya que necesitamos una forma de actualizar los estados de los sujetos que declaramos. Por lo tanto, crearemos un pequeño proyecto para el desarrollo del contrato, tomando como referencia lo [declarado en esta sección](../../../docs/learn/contracts/programming%20contracts/_index.md).
...
Ahora, necesitamos incluir el *esquema*, el *contrato*,el [**génesis**](../../../docs/getting-started/concepts/events/_index.md#types-of-events) estado de un sujeto, así como las políticas que se le aplicarán:
