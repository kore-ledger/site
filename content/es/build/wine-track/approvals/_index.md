...
docker run \
    ...
    -p 50003:50000 \
    -e KORE_HTTP=true \
    -e KORE_ID_PRIVATE_KEY=65698ba9608521d65137912cdd85601820574415ebc3a9a7285e7493012167c6 \
    -e KORE_NETWORK_LISTEN_ADDR=/ip4/0.0.0.0/tcp/50003 \
...
Si un evento requiere aprobación o no depende directamente de su [especificación en el método *contrato*](../../../docs/learn/contracts/programming%20contracts/_index.md). Por lo tanto, debemos agregar `contract_result.approval_required = true;` a nuestro contrato de la siguiente manera:
