...
Whether an event requires approval or not depends directly on its [specification in the *contract* method](../../../docs/learn/contracts/programming%20contracts/_index.md). Therefore, we must add `contract_result.approval_required = true;` to our contract as follows: 

{{< alert-details type="info" title="Contract" summary="Clic to see the contract" >}}
```rust
...
...
To generate these changes, we'll use our [**kore-Patch**](../../../docs/learn/tools/_index.md#kore-patch) tool following this procedure:
...
{{< alert-details type="info" title="Request" summary="Clic to see the request" >}}
```bash
