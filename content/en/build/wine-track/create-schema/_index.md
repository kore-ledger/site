...
The schema must be defined in [*json-schema*](../../../docs/getting-started/concepts/schema/_index.md) format so that kore can interpret it correctly. Here's the schema in this format:
...
After declaring our schema, the next step is to create the [* contract*](../../../docs/learn/contracts/_index.md) as we need a way to update the states of the subjects we declare. Therefore, we'll create a small project for the contract development, taking reference from what has been [declared in this section](../../../docs/learn/contracts/programming%20contracts/_index.md).
...
Now, we need to include the *schema*, the *contract*, the [**genesis**](../../../docs/getting-started/concepts/events/_index.md#types-of-events) state of a subject, as well as the policies that will be applied to them:
